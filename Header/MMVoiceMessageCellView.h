...
@class MMTimer, NSImageView, NSProgressIndicator, NSTextField, NSTextView;
...
@property(retain, nonatomic) NSImageView *unreadTip; // @synthesize unreadTip=_unreadTip;
