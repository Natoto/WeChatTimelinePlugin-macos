...
@class MMComplexContactSearchTask, NSObject<OS_dispatch_queue>;
...
- (void).cxx_destruct;
- (void)doComplexContactSearch:(id)arg1 searchScene:(unsigned long long)arg2 complete:(CDUnknownBlockType)arg3;
