...
@class MMCTTextView, NSImageView, NSProgressIndicator, NSString, NSTextView, NSView;
...
@property(retain, nonatomic) NSView *translationBrandView; // @synthesize translationBrandView=_translationBrandView;
