...
+ (id)getDumpReportDataWithReportType:(unsigned long long)arg1 WithFilePrefix:(id)arg2 WithDate:(id)arg3;
+ (id)getDumpReportDataWithReportType:(unsigned long long)arg1 WithFilePrefix:(id)arg2;
