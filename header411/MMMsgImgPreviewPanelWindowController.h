...
@class MessageData, MsgImgDataLogic, NSString, WCContactData;

@interface MMMsgImgPreviewPanelWindowController : MMBasePreviewPanelWindowController <MsgImgDataLogicDelegate, IMessageExt, MMCDNDownloadMgrExt>
{
...
- (void)updateImageSizeOnCDNDownloadFinish:(id)arg1;
- (id)genPreviewItemWithMessage:(id)arg1;
